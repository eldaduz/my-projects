// ──────────────────────────────────────────────
// GamificationHUD.jsx — Player Stats Bar
//
// Shows the player's level, rank title, XP progress
// bar, and daily streak. All values come from props
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
        ...
        <div className="flex flex-col gap-1 sm:flex-1 sm:max-w-md w-full">
          ...
          <div className="h-2.5 rounded-full bg-surface-1 overflow-hidden border border-border-stroke">
            {/* Bar fill (purple, width set by XP percentage) */}
            <div
